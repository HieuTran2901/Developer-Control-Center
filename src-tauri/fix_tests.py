...
# Replace compute_canonical_fingerprint calls
# from: ApprovalStore::compute_canonical_fingerprint(&Some("echo".to_string()), &vec!["hello".to_string()], Some(1))
# to: ApprovalStore::compute_canonical_fingerprint("Command", Some("echo"), &["hello".to_string()], "E:\\\\Github project\\\\Developer-Control-Center", "1.0", Some(1))

# Let's just find and replace the block again!
